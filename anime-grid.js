...
const APIURL = `https://inaha.ink/api/`;
const ImageURL = `https://inaha.ink/mugd/gameimg/`;


const getCoverURLById = id => `https://inaha.ink/mugd/gameimg/${id}.jpg`;
...
<div class="search-bangumis-box ui-shadow" data-show="false">
    <div class="content-box">
        <form>
            <input type="text" placeholder="列表中没有？在此处输入">
        </form>
        <div class="anime-list"></div>
        <div class="foot">
            <a class="close ui-btn" action="setInputText">使用搜索框中的文字</a>
...
<div class="output-box ui-shadow" data-show="false">
    ...
    downloadImage(){
        ...
        new Image().src = `${APIURL}${this.getBangumiIdsText()}`;
...
Caches[`${APIURL}game`] = [
	...
	{
		"id": 19,
		"title": "BanG Dream! 少女乐团派对"
	},
	{
		"id": 20,
		"title": "世界计划 多彩舞台 feat.初音未来"
	}
